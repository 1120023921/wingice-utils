...
public class HttpRequestUtil {
    ...
    public static String sendGet(String url, String param, Map<String, String> header) {
        ...
        try {
            ...
            final URLConnection connection = setHeader(urlNameString, header);
            // 建立实际的连接
            connection.connect();
    ...
    public static String sendPost(String url, String param, Map<String, String> header) {
        ...
        final StringBuilder result = new StringBuilder();
        try {
            final URLConnection conn = setHeader(url, header);
            // 发送POST请求必须设置如下两行
    ...
    private static URLConnection setHeader(String url, Map<String, String> header) throws IOException {
